...
on_button = ctk.CTkButton(app, text="Turn On LED", command=lambda: send_command("1"))
on_button.pack(pady=5)

off_button = ctk.CTkButton(app, text="Turn Off LED", command=lambda: send_command("0"))
